...
const ChatbotSettings = ({ embedded }: { embedded?: boolean }) => {
  ...
  return (
    <div className={embedded ? "space-y-6" : "min-h-screen flex flex-col bg-background"}>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="space-y-2">
                        ...
                        <Input
                          ...
                          onChange={(e) => setSettingsForm(prev => ({ ...prev, openrouter_api_key: e.target.value }))}
                          placeholder="Leave empty to use environment variable OPENROUTER_API_KEY"
                        />
                        <p className="text-sm text-muted-foreground">
                          If left empty, the system will use the OPENROUTER_API_KEY environment variable.
                        </p>
                      </div>
                      ...
                      <div className="space-y-2">
                        ...
                        <Input
                          ...
                          onChange={(e) => setSettingsForm(prev => ({ ...prev, openrouter_model: e.target.value }))}
                          placeholder="e.g., openai/gpt-4o-mini, anthropic/claude-3.5-sonnet"
                        />
                        <p className="text-sm text-muted-foreground">
                          OpenRouter model identifier (e.g., openai/gpt-4o-mini, anthropic/claude-3.5-sonnet)
                        </p>
                      </div>
