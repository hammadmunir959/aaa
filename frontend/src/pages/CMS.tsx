...
const CMS = () => {
  ...
  const deriveSectionFromPath = (pathname: string): "fleet" | "car-sales" | "news" | "testimonials" => {
  ...
  const [activeTab, setActiveTab] = useState<"fleet" | "car-sales" | "news" | "testimonials">(
    deriveSectionFromPath(location.pathname) as "car-sales" | "news" | "testimonials",
  );
  ...
  const onTabChange = (value: string) => {
    const next = value as "car-sales" | "news" | "testimonials";
    setActiveTab(next);
      ...
      <main className="flex-grow py-8">
        <div className="container mx-auto px-4">
          <div className="mb-6">
            ...
            <p className="text-muted-foreground">Manage Cars for Sale, Blogs/News, Landing Page, and Testimonials</p>
          </div>
