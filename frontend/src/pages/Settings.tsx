...
const Settings = () => {
  ...
  const [companyInfo, setCompanyInfo] = useState({
    name: "AAA Accident Solutions LTD",
    email: "info@aaa-as.co.uk",
    phone: "+44 (0) 800 011 6197",
    logo: "",
  });
            ...
            <div className="grid gap-4">
              ...
              <div className="grid gap-2">
                ...
                <div className="flex items-center gap-4">
                  ...
                  {logoPreview && (
                    <div className="w-24 h-24 rounded-lg overflow-hidden border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-black flex items-center justify-center">
                      <img
                        src={logoPreview}
                        alt="Logo preview"
