...
const WhatsAppButton = () => {
    ...
    return (
        <a
            ...
            className="fixed bottom-36 right-8 z-50 w-14 h-14 rounded-full bg-[#25D366] text-white shadow-lg hover:bg-[#25D366]/90 transition-all duration-300 flex items-center justify-center hover:scale-110"
