...
const buildInitialState = (vehicle?: VehicleModalValues | null): VehicleFormData => ({
  ...
  registeredYearDate: vehicle?.registeredYearDate ?? "",
  ...
  const handleSave = async () => {
    ...
    try {
      const payload: VehiclePayload & { id?: number } = {
        ...
        model_detail: formData.modelDetail.trim() || undefined,
        type: formData.type as VehicleType,
        body_style: formData.bodyStyle.trim() || undefined,
        ...
        engine_size: formData.engineSize.trim() || undefined,
        euro_status: formData.euroStatus.trim() || undefined,
        registered_year_date: formData.registeredYearDate.trim() || undefined,
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="grid gap-6 py-4">
          ...
          <div className="grid gap-2">
            <Label htmlFor="modelDetail">Model Detail</Label>
            <Input
              id="modelDetail"
              placeholder="e.g., E300e 9G-Tronic Auto PHEV EQ Power 320"
              value={formData.modelDetail}
              onChange={(e) => handleInputChange("modelDetail", e.target.value)}
            />
          </div>
          ...
          <div className="grid gap-4 md:grid-cols-3">
            ...
            <div className="grid gap-2">
              <Label htmlFor="registeredYearDate">Registered Date</Label>
              <Input
                id="registeredYearDate"
                placeholder="e.g., 01 Nov 2021"
                value={formData.registeredYearDate}
                onChange={(e) => handleInputChange("registeredYearDate", e.target.value)}
              />
            </div>
          </div>
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <div className="grid gap-2">
              ...
              <Input
                id="engineSize"
                placeholder="e.g., 1991 cc"
                value={formData.engineSize}
                onChange={(e) => handleInputChange("engineSize", e.target.value)}
              />
            </div>
            <div className="grid gap-2">
              <Label htmlFor="euroStatus">Euro Status</Label>
              <Input
                id="euroStatus"
                placeholder="e.g., 6ap"
                value={formData.euroStatus}
                onChange={(e) => handleInputChange("euroStatus", e.target.value)}
              />
            </div>
          </div>
