      ...
      <div className="container mx-auto px-6 py-8">
        <div className="grid grid-cols-1 gap-3 lg:grid-cols-5 items-start">
          <div className="space-y-2">
            <Logo className="h-24 w-52" alt="AAA Accident Solutions LTD" />
        ...
        <div className="border-t border-border mt-6 pt-4 text-center text-xs text-muted-foreground flex flex-col gap-1">
          <p>Copyright &copy; {currentYear} AAA Accident Solutions LTD.</p>
          <p>
            Powered by{" "}
            <a
              href="https://codekonix.vercel.app/"
              target="_blank"
              rel="noreferrer"
