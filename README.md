# AAA Accident Solutions LTD (AAA)
...
EMAIL_HOST_USER=noreply@aaa-as.co.uk
EMAIL_HOST_PASSWORD=your-app-password
EMAIL_PORT=465
EMAIL_USE_SSL=True
DEFAULT_FROM_EMAIL=AAA Accident Solutions LTD Hire <noreply@aaa-as.co.uk>
SUPPORT_EMAIL=info@aaa-as.co.uk

# AI Chatbot (GROQ)
GROQ_API_KEY=your-groq-api-key
OPENROUTER_API_KEY=your-openrouter-api-key  # Optional: Fallback for chatbot when Groq is unavailable
OPENROUTER_MODEL=openai/gpt-oss-20b:free  # Optional: OpenRouter model to use
