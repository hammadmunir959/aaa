...
class Vehicle(models.Model):
    ...
    body_style = models.CharField(max_length=50, blank=True)
    ...
    euro_status = models.CharField(max_length=50, blank=True)
    registered_year_date = models.CharField(max_length=50, blank=True)
