...
class SecurityAuditLogger:
    ...
    @staticmethod
    def log_user_registration(user_id: int, email: str, admin_type: str, ip_address: str, user_agent: str = '') -> None:
    ...
    @staticmethod
    def log_password_reset(user_id: int, email: str, ip_address: str, user_agent: str = '') -> None:
    ...
    @staticmethod
    def log_admin_status_change(admin_user_id: int, target_user_id: int, old_status: str, new_status: str, ip_address: str, user_agent: str = '') -> None:
        """Log admin status change event."""
        logger.info(
            "Admin status change",
            extra={
