...
class SecurityAuditLogger:
    ...
    def log_failed_login(
        email: str, ip_address: str, reason: str = "Invalid credentials"
    ) -> None:
    ...
    def log_permission_denied(
        user: Optional[User], resource: str, action: str, ip_address: str
    ) -> None:
    ...
    def log_rate_limit_exceeded(
        endpoint: str, ip_address: str, user: Optional[User] = None
    ) -> None:
    ...
    def log_user_registration(
        user_id: int, email: str, admin_type: str, ip_address: str, user_agent: str = ""
    ) -> None:
    ...
    def log_password_reset(
        user_id: int, email: str, ip_address: str, user_agent: str = ""
    ) -> None:
