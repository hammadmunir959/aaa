...
CORS_ALLOWED_ORIGINS = os.getenv(
    ...
    'https://aaa-as.co.uk,https://www.aaa-as.co.uk'
).split(',')
...
SESSION_COOKIE_SECURE = os.getenv('SESSION_COOKIE_SECURE', 'True').lower() == 'true'  # Default True for production HTTPS
CSRF_COOKIE_SECURE = os.getenv('CSRF_COOKIE_SECURE', 'True').lower() == 'true'  # Default True for production HTTPS
