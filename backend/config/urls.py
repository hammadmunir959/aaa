...
from chatbot import views as chatbot_views  # Provide direct names for public chatbot endpoints
...
urlpatterns = [
    ...
    path('api/metrics/', include('config.metrics_urls', namespace='metrics')),  # Metrics endpoints
    ...
    path('api/chatbot/messages/', chatbot_views.get_conversation_messages, name='get_conversation_messages'),
    ...
    path('chatbot/message/', chatbot_views.chatbot_message, name='chatbot-message-direct'),
    path('chatbot/messages/', chatbot_views.get_conversation_messages, name='get_conversation_messages-direct'),
    ...
    path('testimonials/', include('testimonials.urls', namespace='testimonials_fallback')),
    ...
    path('cookies/', include('cookie_consent.urls', namespace='cookie_consent_fallback')),
...
if settings.FRONTEND_DIST_FONTS_DIR.exists():
    urlpatterns += [
        re_path(r'^fonts/(?P<path>.*)$', static_serve, {
