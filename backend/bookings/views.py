...
class OperationsDataView(APIView):
    ...
    def get(self, request):
        ...
        client_stats = (
            claims_qs.values('email', 'first_name', 'last_name', 'phone')
            .annotate(
        ...
        # Staff assignments
        staff_qs = User.objects.filter(admin_type__in=[User.ROLE_ADMIN, User.ROLE_SUPER_ADMIN])
        ...
        summary = {
            ...
            'active_bookings': claims_qs.filter(status__in=['pending', 'approved']).count(),
