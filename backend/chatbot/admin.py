...
class ChatbotContextAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Content", {"fields": ("content", "keywords"), "classes": ("collapse",)}),
    )
...
class ConversationAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Status", {"fields": ("is_lead", "ended_at")}),
    )
...
class ChatbotSettingsAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("API Configuration", {"fields": ("api_key", "model")}),
        ("Response Settings", {"fields": ("max_tokens", "temperature")}),
        ("Feature Flags", {"fields": ("is_active", "auto_populate_context")}),
        (
            "Metadata",
