            ...
            def deferred_populate():
                ...
                try:
                    ...
                    if not ChatbotContext.objects.exists():
                        logger.info(
                            "No chatbot contexts found. Populating default contexts..."
                        )
    ...
    def _populate_default_contexts(self):
        ...
        default_contexts = {
            "intro": {
                ...
                "content": """Welcome to AAA Accident Solutions LTD! I'm your AI assistant, here to help you with all your car hire needs.
...
Feel free to ask me anything, and I'll do my best to help you. How can I assist you today?""",
            ...
            "company": {
                ...
                "content": """AAA Accident Solutions LTD is a leading car hire service provider specializing in luxury and premium vehicle rentals.
...
Our mission is to provide you with the best car hire experience, whether you need a vehicle for business, leisure, or special occasions.""",
            ...
            "services": {
                ...
                "content": """AAA Accident Solutions LTD offers a comprehensive range of services:
...
**Address**: Please contact us at info@aaa-as.co.uk for our current office address and location.
...
**Emergency Contact**:
- For urgent matters, contact us via email: info@aaa-as.co.uk
