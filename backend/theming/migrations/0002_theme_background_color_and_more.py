        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        help_text="Display name for the theme", max_length=200
                    ),
                ),
                (
                    "primary_color",
                    models.CharField(
                        default="#0b5cff",
                        help_text="Primary theme color in hex format",
                        max_length=7,
                    ),
                ),
                (
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        default="",
                        help_text="Background color for the website in hex format",
                        max_length=7,
                    ),
                ),
                (
                    ...
                    models.CharField(
                        blank=True,
                        default="",
                        help_text="Main text color in hex format",
                        max_length=7,
                    ),
                ),
                (
                    ...
                    models.CharField(
                        blank=True,
                        default="",
                        help_text="Accent color for buttons and highlights in hex format",
                        max_length=7,
                    ),
                ),
                (
                    ...
                    models.CharField(
                        blank=True,
                        default="",
                        help_text="Path to banner image",
                        max_length=500,
                    ),
                ),
                (
                    ...
                    models.CharField(
                        blank=True,
                        default="",
                        help_text="Hero section background (image URL or color)",
                        max_length=500,
                    ),
                ),
                (
                    ...
                    models.CharField(
                        blank=True,
                        default="",
                        help_text="Path to icons directory",
                        max_length=500,
                    ),
                ),
                (
                    "animations",
                    models.JSONField(
                        blank=True, default=list, help_text="List of animation names"
                    ),
                ),
                (
                    "popup_title",
