...
class Theme(models.Model):
    ...
    scrolling_message = models.CharField(max_length=500, blank=True, default="", help_text="Message to display in the scrolling banner at the top of the homepage")
    scrolling_background_color = models.CharField(max_length=7, default="#000000", help_text="Background color for the scrolling banner in hex format")
   
    
    is_custom = models.BooleanField(default=True, help_text="True for user-created themes, False for system defaults")
    is_active = models.BooleanField(default=False, help_text="If set, this theme will be used globally as default (unless an event overrides it)")
...
class Event(models.Model):
    ...
    pre_activate_days = models.IntegerField(default=0, help_text="Number of days before start_date to automatically activate this theme")
