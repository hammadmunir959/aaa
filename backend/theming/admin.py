...
class ThemeAdmin(admin.ModelAdmin):
    list_display = (
        ...
        "key",
        "scrolling_message",
        "scrolling_background_color",
        "is_custom",
        "is_active",
        "created_at",
    )
    list_filter = ("is_custom", "is_active", "created_at")
    search_fields = ("name", "key", "scrolling_message")
    readonly_fields = ("created_at", "updated_at")

    fieldsets = (
        ("Basic Information", {"fields": ("key", "name", "is_custom", "is_active")}),
        (
            "Scrolling Banner Configuration",
            {"fields": ("scrolling_message", "scrolling_background_color")},
        ),
        (
            "Metadata",
...
class EventAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Basic Information", {"fields": ("name", "slug", "theme_key")}),
        ("Date Range", {"fields": ("start_date", "end_date", "recurring_yearly")}),
        ("Settings", {"fields": ("priority", "active")}),
        (
            "Metadata",
            {"fields": ("created_at", "updated_at"), "classes": ("collapse",)},
        ),
