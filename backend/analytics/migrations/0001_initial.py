    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["page_path", "-viewed_at"],
                        name="analytics_p_page_pa_fe9311_idx",
                    ),
                    models.Index(
                        fields=["-viewed_at"], name="analytics_p_viewed__863699_idx"
                    ),
                    models.Index(
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    ...
                    models.Index(
                        fields=["-first_visit"], name="analytics_v_first_v_562ea9_idx"
                    ),
                ],
            },
        ),
